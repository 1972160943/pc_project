...
int test_img()
{
    ...
    detectornet.load_param("D:/sxj731533730/pc_project/DetectPose/DetectPose/ncnnmodel/person_detector.param");
    detectornet.load_model("D:/sxj731533730 / pc_project / DetectPose / DetectPose / ncnnmodel / person_detector.bin");
    int detector_size_width = 320;
    int detector_size_height = 320;

    //定义人体姿态关键点预测器
    ncnn::Net posenet;
    posenet.load_param("D:/sxj731533730/pc_project/DetectPose/DetectPose/ncnnmodel/Ultralight-Nano-SimplePose.param");
    posenet.load_model("D:/sxj731533730/pc_project/DetectPose/DetectPose/ncnnmodel/Ultralight-Nano-SimplePose.bin");
